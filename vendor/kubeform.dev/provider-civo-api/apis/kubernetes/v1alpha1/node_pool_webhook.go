...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-kubernetes-civo-kubeform-com-v1alpha1-nodepool,mutating=false,failurePolicy=fail,groups=kubernetes.civo.kubeform.com,resources=nodepools,versions=v1alpha1,name=nodepool.kubernetes.civo.kubeform.io,sideEffects=None,admissionReviewVersions=v1

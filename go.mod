module kubeform.dev/provider-civo-controller

go 1.16

require (
	github.com/civo/terraform-provider-civo v0.10.9
	...
	kubeform.dev/provider-civo-api v0.3.1-0.20211020085218-7b3322a3f2c6

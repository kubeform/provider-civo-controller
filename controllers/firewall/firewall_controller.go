...
// +kubebuilder:rbac:groups=firewall.civo.kubeform.com,resources=firewalls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=firewall.civo.kubeform.com,resources=firewalls/status,verbs=get;update;patch
...
func (r *FirewallReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {

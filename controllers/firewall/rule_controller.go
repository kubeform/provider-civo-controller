...
// +kubebuilder:rbac:groups=firewall.civo.kubeform.com,resources=rules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=firewall.civo.kubeform.com,resources=rules/status,verbs=get;update;patch

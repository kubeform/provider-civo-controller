...
// +kubebuilder:rbac:groups=loadbalancer.civo.kubeform.com,resources=loadbalancers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=loadbalancer.civo.kubeform.com,resources=loadbalancers/status,verbs=get;update;patch
...
func (r *LoadbalancerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &loadbalancerv1alpha1.Loadbalancer{}); err != nil {
			klog.Error(err, "unable to set up auditor", loadbalancerv1alpha1.Loadbalancer{}.APIVersion, loadbalancerv1alpha1.Loadbalancer{}.Kind)
			return err
		}
	}

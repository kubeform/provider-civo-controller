...
// +kubebuilder:rbac:groups=volume.civo.kubeform.com,resources=volumes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=volume.civo.kubeform.com,resources=volumes/status,verbs=get;update;patch
...
func (r *VolumeReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {

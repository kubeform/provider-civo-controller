...
// +kubebuilder:rbac:groups=template.civo.kubeform.com,resources=templates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=template.civo.kubeform.com,resources=templates/status,verbs=get;update;patch
...
func (r *TemplateReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &templatev1alpha1.Template{}); err != nil {
			klog.Error(err, "unable to set up auditor", templatev1alpha1.Template{}.APIVersion, templatev1alpha1.Template{}.Kind)
			return err
		}
	}

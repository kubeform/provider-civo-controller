...
// +kubebuilder:rbac:groups=kubernetes.civo.kubeform.com,resources=nodepools,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kubernetes.civo.kubeform.com,resources=nodepools/status,verbs=get;update;patch
...
func (r *NodePoolReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch NodePool")
...
func (r *NodePoolReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &kubernetesv1alpha1.NodePool{}); err != nil {
			klog.Error(err, "unable to set up auditor", kubernetesv1alpha1.NodePool{}.APIVersion, kubernetesv1alpha1.NodePool{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&kubernetesv1alpha1.NodePool{}).
